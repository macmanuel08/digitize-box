        ...
        <section id="services" className="py-24 bg-slate-50 scroll-mt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {/* Web Development */}
                    <Link href="/website-development" className="bg-white px-8 pt-8 pb-8 md:pb-16 rounded-2xl shadow-sm border border-slate-100 hover:shadow-lg transition relative">
                        ...
                        <span className="bg-indigo-600 text-white px-3 py-1 rounded-md text-xs font-bold tracking-wide uppercase mt-4 inline-block static md:absolute left-8 bottom-6">Learn More</span>
                    </Link>
                    {/* EHR System */}
                    <Link href="/ehr-development" className="bg-white px-8 pt-8 pb-8 md:pb-16 rounded-2xl shadow-sm border border-slate-100 hover:shadow-lg transition relative">
                        ...
                        <span className="bg-emerald-600 text-white px-3 py-1 rounded-md text-xs font-bold tracking-wide uppercase mt-4 inline-block static md:absolute left-8 bottom-6">Learn More</span>
                    </Link>
                    
                    {/* Appointment Scheduling */}
                    <Link href="/appointment-scheduling" className="bg-white px-8 pt-8 pb-8 md:pb-16 rounded-2xl shadow-sm border border-blue-100 ring-2 ring-blue-600/10 hover:shadow-lg transition relative overflow-hidden relative">
                        ...
                        <span className="bg-blue-600 text-white px-3 py-1 rounded-md text-xs font-bold tracking-wide uppercase mt-4 inline-block static md:absolute left-8 bottom-6">Learn More</span>
                    </Link>
