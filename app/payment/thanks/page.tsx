    ...
    <main className="flex items-center justify-center py-14">
      <div className="relative mx-auto flex w-full max-w-[800px] flex-col space-y-2.5 p-4">
        ...
        <div className='py-9'>
            ...
            <p className='text-sm text-gray-600 mt-4'> Thank you for being an early supporter! Your subscription price of <span className="text-blue-500 font-semibold">&#8369;599</span> will remain locked forever as we continue improving and expanding the app.</p>
        </div>
      </div>
    </main>
  );
